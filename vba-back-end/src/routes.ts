...
export function routes(app: Application, ctx: ApplicationContext): void {
	...
	app.get('/tournaments/matches/:tournament', ctx.tournament.GetGeneratedMatches);

	app.post('/tournaments/createSeasonAndAddToTournament/:tournamentId', ctx.tournament.createSeasonAndAddToTournament);
	...
	app.get('/players/getplayersbyteamid/:teamId', ctx.player.getPlayersByTeamId);
