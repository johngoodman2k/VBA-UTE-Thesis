...
export const NavigationBar = (props: NavigationBarProps) => {
  ...
  return (
    <>
      <header
        ref={props.ref}
        className={`m-0 p-0 z-[110] relative w-full inline-block box-border align-middle ${cx(
          "__wrapper"
        )}`}
      >
        <div className={cx("__block")}>
          <div className="relavitve w-full h-full p-0 pl-[5%] pr-[5%] text-third-color">
            <div
              className={`w-[743px]  relative float-left text-right h-full ${cx(
                "__left"
              )}`}
            >
              <div></div>
              <div className="h-full text-left pr-0 inline-block align-middle">
                <nav
                  className={`w-auto h-full m-0 relative inline-block align-middle ${cx(
                    "__main-menu"
                  )} `}
                >
            ...
            <div
              className={` absolute  w-full left-0 text-center h-full align-middle   ${cx(
                "__center"
              )}`}
            >
                ...
                <div className="inline-block align-middle leading-4">
                  <a className="relative inline-block max-w-[100%] max-h-[130px] h-[128px]">
                    <img
                      ...
                      className="m-center h-full w-auto"
                    ></img>
                  </a>
                </div>
              </div>
            ...
            <div
              className={`w-[743px] z-2 relative float-right text-left h-full ${cx(
                "__right"
              )}`}
            >
              <div></div>
                  ...
                  <ul className={cx("__left-divided")}>
                    <li>
                      <a
                        id="results"
                        onClick={(e: any) =>
                          e.currentTarget.id === "results"
                            ? setClickedId("results")
                            : ""
                        }
                        className={cx("__left-divided__elements")}
                      >
                    ...
                    <li>
                      <a
                        id="fixtures"
                        onClick={(e: any) =>
                          e.currentTarget.id === "fixtures"
                            ? setClickedId("fixtures")
                            : ""
                        }
                        className={cx("__left-divided__elements")}
                      >
