    ...
    <div className={cx("PlayerInformation")}>
      ...
      <div className={`${cx("PlayerInformation__Information")}`}>
        ...
        <div className={cx("PlayerInformation__Information__TeamLogo")}>
          <div
            className={cx(
              "PlayerInformation__Information__TeamLogo__LogoBlock"
            )}
          >
            <img
              ...
              alt="logo"
              className={cx(
                "PlayerInformation__Information__TeamLogo__LogoBlock__Logo"
              )}
            ></img>
          </div>
        </div>
        ...
        <div className={cx("TopWarp")}>
          <div
            className={cx("PlayerInformation__Information__InformationBlock")}
          >
            {/* image bên trái */}
            <div
              className={cx(
                "PlayerInformation__Information__InformationBlock__ImageBlock"
              )}
            >
              <div
                className={cx(
              ...
              >
                <a
                  className={cx(
                    "PlayerInformation__Information__InformationBlock__ImageBlock__ImageWarp__TeamLogo"
                  )}
                  href="/"
                >
                  <img
            ...
            <div
              className={cx(
                "PlayerInformation__Information__InformationBlock__ContentBlock"
              )}
            >
              <div
                className={cx(
                  "PlayerInformation__Information__InformationBlock__ContentBlock__Content"
                )}
              >
                <div className="flex flex-col text-white">
                  <p className="t11 md:t2">
                    Golden State Warriors | #30 | Guard
                  </p>
                  <p
                    className={cx(
                      "PlayerInformation__Information__InformationBlock__ContentBlock__Content__TextName"
                    )}
                  >
                    Stephen
                  </p>
        ...
        >
          ...
          >
            <div className="flex justify-center items-center flex-col">
              <p
                className={cx(
                  "PlayerInformation__PlayerSumaryWrap__PlayerSumary__Game__Text"
                )}
              >
                PPG
              </p>
              <p
                className={cx(
                  "PlayerInformation__PlayerSumaryWrap__PlayerSumary__Game__Number"
                )}
              >
                102
              </p>
          ...
          >
            <div className={`grid grid-rows-2 divide-y divide-[#0268d6]`}>
              <div className="flex justify-center items-center flex-col">
                <p
                  className={cx(
                    "PlayerInformation__PlayerSumaryWrap__PlayerSumary__Detailt__Text"
                  )}
                >
                  HEIGHT
                </p>
                <p
                  className={cx(
                    "PlayerInformation__PlayerSumaryWrap__PlayerSumary__Detailt__Number"
                  )}
                >
                  102
                </p>
